...
* #### [Generating Long and Informative Reviews with Aspect-Aware Coarse-to-Fine Decoding](http://arxiv.org/pdf/1906.05667v1)
...
* #### [Deep Dominance - How to Properly Compare Deep Neural Models](https://ie.technion.ac.il/~roiri/papers/DeepDominance.pdf)
...
* #### [Manipulating the Difficulty of C-Tests](http://arxiv.org/pdf/1906.06905v1)
...
* #### [Heuristic Authorship Obfuscation](https://webis.de/downloads/publications/papers/stein_2019m.pdf)
...
* #### [Multi-Source Cross-Lingual Model Transfer: Learning What to Share](https://arxiv.org/pdf/1810.03552.pdf)
...
* #### [Multi-Level Matching and Aggregation Network for Few-Shot Relation Classification](http://arxiv.org/pdf/1906.06678v1)
...
* #### [Coupling Retrieval and Meta-Learning for Context-Dependent Semantic Parsing](http://arxiv.org/pdf/1906.07108v1)
...
* #### [Unsupervised Neural Single-Document Summarization of Reviews via Learning Latent Discourse Structure and its Ranking](http://arxiv.org/pdf/1906.05691v1)
...
* #### [Meaning to Form: Measuring Systematicity as Information](http://arxiv.org/pdf/1906.05906v1)
...
* #### [An Interactive Multi-Task Learning Network for End-to-End Aspect-Based Sentiment Analysis](http://arxiv.org/pdf/1906.06906v1)
...
* #### [E3: Entailment-driven Extracting and Editing for Conversational Machine Reading](http://arxiv.org/pdf/1906.05373v1)
...
* #### [Interconnected Question Generation with Coreference Alignment and Conversation Flow Modeling](http://arxiv.org/pdf/1906.06893v1)
...
* #### [GraphRel: Modeling Text as Relational Graphs for Joint Entity and Relation Extraction](https://tsujuifu.github.io/projs/acl19_graph-rel.html)
...
* #### [Improved Sentiment Detection via Label Transfer from Monolingual to Synthetic Code-Switched Text](http://arxiv.org/pdf/1906.05725v1)
...
* #### [RankQA: Neural Question Answering with Answer Re-Ranking](https://arxiv.org/pdf/1906.03008.pdf)
...
* #### [Lattice Transformer for Speech Translation](http://arxiv.org/pdf/1906.05551v1)
...
* #### [Open Domain Event Extraction Using Neural Latent Variable Models](http://arxiv.org/pdf/1906.06947v1)
...
* #### [Matching the Blanks: Distributional Similarity for Relation Learning](https://www.groundai.com/project/matching-the-blanks-distributional-similarity-for-relation-learning/)
...
* #### [DisSent: Learning Sentence Representations from Explicit Discourse Relations](https://arxiv.org/pdf/1710.04334.pdf)
...
* #### [COMET: Commonsense Transformers for Automatic Knowledge Graph Construction](http://arxiv.org/pdf/1906.05317v1)
...
* #### [Dynamically Composing Domain-Data Selection with Clean-Data Selection by ``Co-Curricular Learning" for Neural Machine Translation](https://arxiv.org/pdf/1906.01130.pdf)
...
* #### [SParC: Cross-Domain Semantic Parsing in Context](https://arxiv.org/pdf/1906.02285.pdf)
...
* #### [Scalable Syntax-Aware Language Models Using Knowledge Distillation](http://arxiv.org/pdf/1906.06438v1)
...
* #### [Improving Multi-turn Dialogue Modelling with Utterance ReWriter](http://arxiv.org/pdf/1906.07004v1)
...
* #### [Keeping Notes: Conditional Natural Language Generation with a Scratchpad Encoder](https://arxiv.org/pdf/1906.05275.pdf)
...
* #### [Neural Decipherment via Minimum-Cost Flow: from Ugaritic to Linear B](http://arxiv.org/pdf/1906.06718v1)
...
* #### [Persuasion for Good: Towards a Personalized Persuasive Dialogue System for Social Good](http://arxiv.org/pdf/1906.06725v1)
...
* #### [Learning to Ask Unanswerable Questions for Machine Reading Comprehension](http://arxiv.org/pdf/1906.06045v1)
...
* #### [Real-Time Open-Domain Question Answering with Dense-Sparse Phrase Index (DenSPI)](https://arxiv.org/pdf/1906.05807.pdf)
...
* #### [Figurative Usage Detection of Symptom Words to Improve Personal Health Mention Detection]( http://arxiv.org/pdf/1906.05466v1)
...
* #### [How to best use Syntax in Semantic Role Labelling](https://arxiv.org/pdf/1906.00266.pdf)
...
* #### [A Simple and Effective Approach to Automatic Post-Editing with Transfer Learning](https://arxiv.org/pdf/1906.06253.pdf)
...
* #### [Know What You Don't Know: Modeling a Pragmatic Speaker that Refers to Objects of Unknown Categories](http://arxiv.org/pdf/1906.05518v1)
...
* #### [Translating Translationese: A Two-Step Approach to Unsupervised Machine Translation](https://www.isi.edu/~jonmay/pubs/acl19.pdf)
...
* #### [Making Fast Graph-based Algorithms with Graph Metric Embeddings](http://arxiv.org/pdf/1906.07040v1)
...
* #### [Towards Integration of Statistical Hypothesis Tests into Deep Neural Networks](http://arxiv.org/pdf/1906.06550v1)
Ahmad Aghaebrahimian, Mark Cieliebak

* #### [Why Didn’t You Listen to Me? Comparing User Control of Human-in-the-Loop Topic Models](https://arxiv.org/pdf/1905.09864.pdf)
Varun Kumar, Alison Smith-Renner, Leah Findlater, Kevin Seppi, Jordan Boyd-Graber

* #### [Synthetic QA Corpora Generation with Roundtrip Consistency](http://arxiv.org/pdf/1906.05416v1)
...
* #### [Robust Zero-Shot Cross-Domain Slot Filling with Example Values](http://arxiv.org/pdf/1906.06870v1)
...
* #### [Storyboarding of Recipes: Grounded Contextual Generation](https://openreview.net/pdf?id=rJeQE8LYdV)
...
* #### [Evaluating Gender Bias in Machine Translation](https://arxiv.org/pdf/1906.00591.pdf)
...
* #### [Are Red Roses Red? Evaluating Consistency of Question-Answering Models](http://sameersingh.org/files/papers/impl-acl19.pdf)
...
* #### [Improving Visual Question Answering by Referring to Generated Paragraph Captions](http://arxiv.org/pdf/1906.06216v1)
...
* #### [A Multi-Task Architecture on Relevance-based Neural Query Translation](http://arxiv.org/pdf/1906.06849v1)
...
* #### [We need to talk about standard splits](http://wellformedness.com/papers/gorman-bedrick-2019.pdf)
...
* #### [KCAT: A Knowledge-Constraint Typing Annotation Tool](http://arxiv.org/pdf/1906.05670v1)
...
<strong>A computational linguistic study of personal recovery in bipolar disorder</strong></a><br><i>Glorianna Jagfeld</i></br></summary>
<p>Mental health research can benefit increasingly fruitfully from computational linguistics methods, given the abundant availability of language data in the internet and advances of computational tools. This interdisciplinary project will collect and analyse social media data of individuals diagnosed with bipolar disorder with regard to their recovery experiences. Personal recovery - living a satisfying and contributing life along symptoms of severe mental health issues - so far has only been investigated qualitatively with structured interviews and quantitatively with standardised questionnaires with mainly English-speaking participants in Western countries. Complementary to this evidence, computational linguistic methods allow us to analyse first-person accounts shared online in large quantities, representing unstructured settings and a more heterogeneous, multilingual population, to draw a more complete picture of the aspects and mechanisms of personal recovery in bipolar disorder.</p>
</details>
...
* #### [Enriching Neural Models with Targeted Features for Dementia Detection](http://arxiv.org/pdf/1906.05483v1)
...
* #### [Unsupervised Learning of Discourse-Aware Text Representation for Essay Scoring](https://www.anlp.jp/proceedings/annual_meeting/2019/pdf_dir/B6-1.pdf)
